...
typologies = ['Fournitures', 'Services', 'Travaux', 'Etude']
...
def calculer_visa(row):
    ...
    elif row['Typologie du marché'] == 'Etude':
        if row['Montant du contrat'] > 6000000 and row['Garantie'] == 'Aucune':
            return 'Non'
        if row['Délai de réalisation'] > 6:
            return 'Non'
